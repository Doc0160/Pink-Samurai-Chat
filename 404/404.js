...
(function(){
	...
	overlay = document.querySelector( '#back>#text>div' );
	...
	for( var i = 0, len = eyes.length; i < len; i++ ) {
	    ...
	    if( seconds > OVERLAY_DURATION && overlay !== undefined ) {
	        ...
	        // Ease-in
	        //overlayOpacity *= 1.06 + ( 0.055 * overlayOpacity );
	        //overlayOpacity = Math.min( overlayOpacity + 0.01, 1);
                            ...
                            setTimeout(function(){
                                ...
                                setTimeout(function(){
                                    ...
                                    setTimeout(function(){
                                        ...
                                        fadeIn(document.getElementById("back"));
                                        fadeOut(canvas);
